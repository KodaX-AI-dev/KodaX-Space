...
- Published Space Baseline: KodaX Space `v0.1.46-beta.3` / KodaX `0.7.96-rc.4`（来源：该发布 tag 的 `package-lock.json`；当前 main 可含后续未发布改动）
...
Integration evidence: PF001–PF013 existing implementations entered `main` in [PR #5](https://github.com/KodaX-AI-dev/KodaX-Space/pull/5) at `a2f7a1b0` and ship in [Space beta.3](https://github.com/KodaX-AI-dev/KodaX-Space/releases/tag/v0.1.46-beta.3). This does not complete the remaining development or real-account acceptance for PF001–PF003. Existing F146 mappings are retained; no new Space F-ID is assigned.

## Feature Index

| ID    | Title                                                | Category    | Priority | Partner Target | Dev Status | Integration | Space Feature | Design                                           |
| ----- | ---------------------------------------------------- | ----------- | -------- | -------------- | ---------- | ----------- | ------------- | ------------------------------------------------ |
| PF001 | Partner Extension & Expert Library                   | New         | High     | `v0.1.0`       | InProgress | Integrated       | F146          | [PF001 design](features/v0.1.0.md#feature-pf001) |
| PF002 | Governed Connector Previews & Feishu Platform Expert | New         | High     | `v0.1.0`       | InProgress | Integrated       | F146          | [PF002 design](features/v0.1.0.md#feature-pf002) |
| PF003 | Receipt-First Delivery & Unified Workspace           | Enhancement | High     | `v0.1.0`       | InProgress | Integrated       | F146          | [PF003 design](features/v0.1.0.md#feature-pf003) |
| PF004 | Shared Connector Capabilities & Builder Methodology  | Enhancement | High     | `v0.1.0`       | Completed  | Integrated       | —             | [PF004 design](features/v0.1.0.md#feature-pf004) |
| PF005 | Tencent Docs & Personal Mail Connectors              | New         | High     | `v0.1.0`       | Completed  | Integrated       | —             | [PF005 design](features/v0.1.0.md#feature-pf005) |
| PF006 | Slack, Zoom & GitHub Read Connectors                 | New         | High     | `v0.1.0`       | Completed  | Integrated       | —             | [PF006 design](features/v0.1.0.md#feature-pf006) |
| PF007 | Composable Experts & Shared Connector Guidance       | Enhancement | High     | `v0.1.0`       | Completed  | Integrated       | —             | [PF007 design](features/v0.1.0.md#feature-pf007) |
| PF008 | Persistent Expert Conversations                      | Enhancement | High     | `v0.1.0`       | Completed  | Integrated       | —             | [PF008 design](features/v0.1.0.md#feature-pf008) |
| PF009 | Reusable Expert Catalog Expansion | Enhancement | High | `v0.1.0` | Completed | Integrated | — | [PF009 design](features/v0.1.0.md#feature-pf009) |
| PF010 | Office Expert Research & Reuse | Enhancement | High | `v0.1.0` | Completed | Integrated | — | [PF010 design](features/v0.1.0.md#feature-pf010) |
| PF011 | Expert Portraits & Browsable Profiles | Enhancement | High | `v0.1.0` | Completed | Integrated | — | [PF011 design](features/v0.1.0.md#feature-pf011) |
| PF012 | Partner Cold-start Home | Enhancement | Medium | `v0.1.0` | Completed | Integrated | — | [PF012 design](features/v0.1.0.md#feature-pf012) |
| PF013 | Sales, Hiring, Onboarding & Presentations | Enhancement | Medium | `v0.1.0` | Completed | Integrated | — | [PF013 design](features/v0.1.0.md#feature-pf013) |
...
- Integration Status: Integrated
- Space Feature: —（本次保留 Partner PF 编号，未新增 Space F-ID）
...
- Dev Status: Completed
- Integration Status: Integrated
- Space Feature: —（本次未新增 Space F-ID）
...
- Created: 2026-09-07
- Updated: 2026-09-14
- Evidence: [PF008 验收记录](features/PF008-persistent-expert-validation.md)；全量 4,027 PASS / 4 平台跳过，修复后 22 项 UI 回归通过；双轴评审无未处理发现，macOS arm64 隔离桌面通过；当时未发布，当前 beta.3 交付见上方集成证据。
