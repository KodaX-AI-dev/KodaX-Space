...
- 当前已交付基线为 [Space `0.1.46-beta.3`](https://github.com/KodaX-AI-dev/KodaX-Space/releases/tag/v0.1.46-beta.3) / KodaX `0.7.96-rc.4`。后续发布先核对组织已有版本，使用未占用的新版本并同步 manifests、CHANGELOG 和更新元数据，不覆盖既有 tag 或 Release 资产。
...
[Space beta.3](https://github.com/KodaX-AI-dev/KodaX-Space/releases/tag/v0.1.46-beta.3) 已通过组织主线和既有发布流程交付。以下门槛适用于后续功能与新版本：
